...
///    NODE_PATH='../libraryApp/code/node_modules' 
///    node.exe runSharpJS.js --imgFile image.jpg
///    USE NODE.EXE, NOT NODE OR GIT-BASH SAYS "NOT A TTY"
...
async function doAll() {
  ...
  console.log('++ imgFile: ' + argv.imgFile)
  ...
  var mdata = await sharpImg.metadata(); 
  mdata.icc = "removed because its very very long";
  mdata.exif.data = "removed because its very very long";
  ...
  const filepromise = sharpImg.resize({ width: 55 }).toFile(newname(prefix, 55))
